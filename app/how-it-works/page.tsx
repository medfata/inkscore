...
const platformMetrics: PlatformRule[] = [
  ...
  },
  {
    ...
    description: 'Swap volume through the Ink Brokers FloorRouter venue + desk activity on ERC-6551 broker accounts',
    formula: 'Tiered: $1-$99.99 = 1,000pts, $100-$1K = 2,500pts, >$1K = 5,000pts',
    details: [
      'Tier 1: $1-$99.99 swap volume = 1,000 points',
      'Tier 2: $100-$1,000 swap volume = 2,500 points',
      'Tier 3: >$1,000 swap volume = 5,000 points',
      'Desk activity (clock-ins, claims, active seats) is tracked on the dashboard',
    ],
    color: 'from-amber-500 to-orange-500',
    url: 'https://inkbrokers.com',
  },
  {
    name: 'InkScore Zenith (NFTs)',
    logo: 'https://i2c.seadn.io/collection/inkscore-zenith/image_type_logo/831152ff66038d827191d68d3d66b9/2f831152ff66038d827191d68d3d66b9.png?h=250&w=250',
    description: 'Points for holding InkScore Zenith NFTs',
    formula: 'Tiered: 1 NFT = 1,000pts, 2-8 NFTs = 2,500pts, 9+ NFTs = 5,000pts',
    details: [
      'Tier 1: 1 NFT held = 1,000 points',
      'Tier 2: 2-8 NFTs held = 2,500 points',
      'Tier 3: 9+ NFTs held = 5,000 points',
      'Maximum possible: 5,000 points',
    ],
    color: 'from-purple-500 to-violet-500',
    url: 'https://opensea.io/collection/inkscore-zenith',
  },
  {
    ...
    details: [
      'Tier 1: 1 NFT staked = 2,000 points',
      'Tier 2: 2-8 NFTs staked = 4,000 points',
      'Tier 3: 9+ NFTs staked = 6,000 points',
      'Maximum possible: 6,000 points',
    ],
    color: 'from-emerald-500 to-teal-500',
    url: 'https://inkscore.xyz/staking',
  },
  {
    name: 'Hypercall Earn',
  ...
  },
  {
    ...
    details: [
      'Every game purchased (round or pack) = 500 points',
      'Points stop after 3 games',
      'Maximum possible: 1,500 points',
    ],
    color: 'from-cyan-500 to-teal-500',
    url: 'https://gonefishin.ink',
  },
  {
    name: 'Shellies',
