...
import { DashboardCardWithRelations, DashboardCardData } from '@/lib/types/dashboard';
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch dashboard card data' }, { status: 500 });
  }
}
