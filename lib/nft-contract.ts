// InkScore NFT Contract Configuration
// Deployed on Ink Chain

export const NFT_CONTRACT_ADDRESS = (process.env.NEXT_PUBLIC_NFT_CONTRACT_ADDRESS || "0xABbdc8230AD27a1C128Ff6F81a8EB98673c32eF9") as `0x${string}`;

export const NFT_CONTRACT_ABI = [
  {
    inputs: [
      { internalType: "string", name: "baseURI", type: "string" },
      { internalType: "address", name: "_authorizedSigner", type: "address" }
    ],
...
export const INK_CHAIN_ID = 57073; // Mainnet
export const INK_TESTNET_CHAIN_ID = 763373; // Sepolia testnet
