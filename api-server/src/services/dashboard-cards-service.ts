...
// Sprint 2: verbatim extraction of the GET /api/dashboard/cards/:wallet
// handler from routes/dashboard.ts. Pure DB composition (dashboard_cards,
// dashboard_card_metrics, dashboard_card_platforms, platforms, contracts,
// user_analytics_cache). No logic changed.

/**
 * Build the dashboard cards payload for a wallet. Throws on DB failure —
 * the route shell maps that to the original 500.
 */
export async function getDashboardCards(walletAddress: string): Promise<DashboardCardsResponse> {
